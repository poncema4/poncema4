...
- **[OpenAI-API](https://github.com/poncema4/OpenAI-API)**: Using OpenAI's API and Canvas's API get the latest discussion post and automatically reply using Command Prompt
---
